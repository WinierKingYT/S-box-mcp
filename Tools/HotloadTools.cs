...
{
	[McpTool("sbox_hotload_trigger", "Triggers a script hot-reload.")]
	...
	[McpTool("sbox_hotload_status", "Checks if hotload API is available and returns detected types.")]
	...
	[McpTool("sbox_hotload_code", "Writes a code snippet to a file and triggers hot-reload.")]
