...
public class ServerTools
{
	...
	[McpTool("sbox_read_file", "Reads file contents from the data directory.")]
	...
	[McpTool("sbox_write_file", "Writes content to a file in the data directory. Only .json, .txt, .xml allowed.")]
	...
	[McpTool("sbox_delete_file", "Deletes a file from the data directory.")]
