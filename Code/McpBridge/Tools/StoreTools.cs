...
public class StoreTools
{
	...
	[McpTool("sbox_get_quota", "Current player quota and economy status", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_alarm", "Current security alarm level", ReadOnlyHint = true)]
	...
	[McpTool("sbox_trigger_alarm", "Trigger the security alarm", OptionalParams = new[]{"amount", "x", "y", "z"}, DestructiveHint = true)]
	...
	[McpTool("sbox_get_checkout_zones", "List all checkout zones with cashier patience", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_blackmarket_items", "List available black market items", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_bots", "List all DummyBot NPCs in the scene", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_scene_items", "List all CartItem components in the scene", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_shelves", "List all ProductSpawner shelves with stock info", ReadOnlyHint = true)]
...
{
	[McpTool("sbox_spawn_customer", "Spawns a DummyBot customer at a position", OptionalParams = new[]{"x", "y", "z", "speed", "collectRange"}, DestructiveHint = true)]
	...
	[McpTool("sbox_set_item_price", "Override prices for all items matching a value range", OptionalParams = new[]{"minValue", "maxValue", "newValue"}, DestructiveHint = true)]
	...
	[McpTool("sbox_cart_boost", "Apply a nitro boost to the player's cart", DestructiveHint = true)]
	...
	[McpTool("sbox_force_phase", "Force the game to advance to the next phase immediately", DestructiveHint = true)]
	...
	[McpTool("sbox_respawn_shelves", "Respawn all items on all ProductSpawner shelves", DestructiveHint = true)]
