...
{
	[McpTool("sbox_ui_world_panel", "Creates a WorldPanel on a GameObject. Renders a Razor UI in 3D space.", OptionalParams = new[]{"guidStr", "name", "width", "height", "razorPath"}, DestructiveHint = true)]
	...
	[McpTool("sbox_ui_text_display", "Creates a TextDisplay on a GameObject. Shows text in 3D space.", OptionalParams = new[]{"guidStr", "name", "text", "color", "size"}, DestructiveHint = true)]
	...
	[McpTool("sbox_ui_set_text", "Updates the text content of a TextDisplay component on a GameObject.", DestructiveHint = true)]
