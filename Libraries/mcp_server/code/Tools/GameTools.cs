...
{
	[McpTool("sbox_find_carts", "Finds all cart GameObjects in the scene.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_cart_info", "Returns detailed info about a GameObject.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_spawn_cart", "Spawns a new GameObject at a position.", OptionalParams = new[]{"name"}, DestructiveHint = true)]
	...
	[McpTool("sbox_remove_gameobject", "Removes a GameObject by GUID.", DestructiveHint = true)]
	...
	[McpTool("sbox_set_gameobject_position", "Sets the position of a GameObject.", DestructiveHint = true)]
	...
	[McpTool("sbox_set_gameobject_rotation", "Sets the rotation (pitch,yaw,roll) of a GameObject.", DestructiveHint = true)]
	...
	[McpTool("sbox_set_sun_direction", "Sets the DirectionalLight direction.", DestructiveHint = true)]
	...
	[McpTool("sbox_list_macros", "Lists all saved macros.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_macro", "Gets a saved macro by name.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_save_macro", "Saves a macro (list of tool steps).", OptionalParams = new[]{"description"}, DestructiveHint = true)]
	...
	[McpTool("sbox_delete_macro", "Deletes a saved macro.", DestructiveHint = true)]
	...
	[McpTool("sbox_list_snapshots", "Lists all saved scene snapshots.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_health", "Returns health metrics for the MCP server.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_metrics", "Returns per-tool performance metrics.", ReadOnlyHint = true)]
	public object Metrics()
	{
		return McpReplay.GetAnalytics();
	}

	[McpTool("sbox_clear_replay", "Clears all replay history.", DestructiveHint = true)]
	public object ClearReplay() { McpReplay.Clear(); return new { success = true }; }

	[McpTool("sbox_replay_playback", "Starts replaying recorded commands.", DestructiveHint = true)]
