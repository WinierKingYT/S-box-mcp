...
public class PhysicsTools
{
	...
	[McpTool("sbox_set_gravity", "Sets the scene's global gravity vector.", OptionalParams = new[]{"x", "y", "z"}, DestructiveHint = true)]
	...
	[McpTool("sbox_get_gravity", "Returns the current global gravity vector.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_set_timescale", "Sets the global time scale (1.0 = normal speed).", OptionalParams = new[]{"scale"}, DestructiveHint = true)]
	...
	[McpTool("sbox_get_velocity", "Returns the velocity of a GameObject's Rigidbody.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_overlap_sphere", "Finds GameObjects with colliders in a sphere radius.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_get_physics_bodies", "Lists all GameObjects with a Rigidbody.", OptionalParams = new[]{"filter"}, ReadOnlyHint = true)]
	...
	[McpTool("sbox_add_force", "Applies an impulse force to a Rigidbody.", OptionalParams = new[]{"dx", "dy", "dz", "magnitude"}, DestructiveHint = true)]
	...
	[McpTool("sbox_add_torque", "Applies angular impulse to a Rigidbody.", OptionalParams = new[]{"tx", "ty", "tz"}, DestructiveHint = true)]
