...
public class EffectsTools
{
	...
	[McpTool("sbox_set_master_volume", "Set master volume (0.0 = silent, 1.0 = full).", DestructiveHint = true)]
	...
	[McpTool("sbox_get_master_volume", "Returns current master volume level.", ReadOnlyHint = true)]
	...
	[McpTool("sbox_emit_particle", "Spawns a particle effect at a world position. Creates a temporary ParticleSystem component.", OptionalParams = new[]{"forwardX", "forwardY", "forwardZ"}, DestructiveHint = true)]
	...
	[McpTool("sbox_stop_particles", "Stops all active particle effects.", DestructiveHint = true)]
